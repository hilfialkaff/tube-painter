...
\begin{abstract}
In this paper we describe the formatting requirements for CHI2012 Extended Abstracts and offer recommendations on writing for the worldwide SIGCHI readership.
\end{abstract}

\keywords{\plainkeywords}

\category{H.5.m}{Information interfaces and presentation (e.g., HCI)}{Miscellaneous}.
See \cite{ACMCCS} for help using the ACM Classification system.
